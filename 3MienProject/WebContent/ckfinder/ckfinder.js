...
(function() {
		...
		var k = function() {
			...
			if (s) {
				u.setRequestHeader('Content-type',
						'application/x-www-controller-urlencoded; charset=utf-8');
				u.send(s);
			} else
				u.send(null);
			return t ? '' : r(u);
	...
	(function() {
		...
		a.nd = "\154\x6f";
		a.jG = "\x68\157";
		a.hf = new window["\x52\145\147\x45\170\160"](
															...
															.sendCommand(
																	...
																	function(v) {
																		...
																		s.config.thumbsEnabled = v
																				.selectSingleNode(x
																						+ "\x40\x74\x68\x75\155\x62\163\105\x6e\x61\x62\x6c\145\144").value == 'true';
																		s.config.thumbsDirectAccess = false;
																		if (s.config.thumbsEnabled) {
																			w = v
																					.selectSingleNode(x
																							+ "\x40\x74\x68\x75\155\142\x73\x55\162\x6c");
																			if (w)
																				s.config.thumbsUrl = w.value;
																			w = v
																					.selectSingleNode(x
																							+ "\x40\164\150\x75\x6d\x62\x73\104\x69\162\145\x63\164\101\143\143\145\163\163");
																			if (w)
																				s.config.thumbsDirectAccess = w.value == 'true';
																			w = v
																					.selectSingleNode(x
																							+ "\x40\164\x68\165\x6d\142\x73\127\x69\144\x74\x68");
																			...
																			w = v
																					.selectSingleNode(x
																							+ "\x40\164\150\165\155\142\163\110\x65\151\x67\150\164");
																		...
																		s.config.imagesMaxWidth = parseInt(
																				v
																						.selectSingleNode(x
																								+ "\100\151\x6d\147\x57\151\x64\x74\150").value,
																				10);
																		s.config.imagesMaxHeight = parseInt(
																				v
																						.selectSingleNode(x
																								+ "\x40\151\x6d\147\110\x65\151\x67\150\x74").value,
																				10);
																		w = v
																				.selectSingleNode(x
																						+ "\x40\165\x70\154\157\x61\144\115\x61\170\123\151\172\145");
																		...
																		w = v
																				.selectSingleNode(x
																						+ "\100\x75\x70\x6c\x6f\x61\x64\103\x68\x65\143\153\111\155\141\x67\145\x73");
																		s.config.uploadCheckImages = w ? w.value == 'true'
																				: false;
																		var y = v
																				.selectSingleNode(x
																						+ "\x40\x70\154\165\x67\x69\156\163"), z = y
																				&& y.value;
																		if (z
																				&& z.length)
																			o
	...
	(function() {
		var r, s = {
			fX : /[^\.]+$/,
			iz : /[\\\/:\*\?"<>\|]/
		}, t = '<span class="dropdown">▼</span>', u = '<a href="javascript:void(0)" class="dropdown">▼</a>';
		function v(M) {
		...
		var w = [
				...
				'<tbody>', '</tbody>', '</table>' ], x = [ 'Node',
				"\x6d\x65\163\163\x61\x67\x65" ];
		function y(M) {
			var N = x.reverse().join(''), O = M.tools.of(), P = O['se'
					+ "\x74\110\164\155\x6c"];
			P.call(O, M.qX());
		...
		function z(M) {
			...
			if (!!a.ed && N[0] != v(a.ed.length + a.bs.indexOf(N[1])))
				y(M);
		}
		;
		o
				.add(
						'filesview',
						{
															...
															elements : [
																	...
																	},
																	{
																		...
																		children : [ {
																			...
																			items : [
																					[
																							N.lang.FileAutorename,
																							'autorename' ],
																					[
																							N.lang.FileOverwrite,
																							'overwrite' ],
																					[
																							N.lang.common.skip,
																							'skip' ] ]
							...
							bz : function O(M) {
								var N = this;
								M.rQ.jh = new RegExp('^(' + M.config.fileIcons
										+ ')$', 'i');
										...
										.on(
												...
												function R(P) {
													if (P.data.space == 'mainMiddle') {
														...
														if (!i)
															Q = w[0] + w[3];
														P.data.html += "<div id='files_view' class='view widget files_thumbnails' aria-live='polite' role='main' tabindex='0' aria-controls='status_view'><h4 class='message_content'></h4><div class='files_thumbnails fake no_list' role='list'></div>"
																+ Q + '</div>';
													}
												});
								M
																		...
																		exec : function(
																			...
																			if (U) {
																				if (T
																					...
																					return;
																				var V = window.screen.width * 0.8, W = window.screen.height * 0.7, X = 'menubar=no,location=no,status=no,toolbar=no,scrollbars=yes,resizable=yes';
																				X += ',width='
																						+ V;
																				X += ',height='
																						+ W;
																				X += ',left='
																						+ (window.screen.width - V)
																						/ 2;
																				X += ',top='
																						+ (window.screen.height - W)
																						/ 2;
																				var Y = T.cg.inPopup ? T.document
																						.getWindow().$.parent
																						: window;
																				if (!Y
																						.open(
																					...
																					T
																							.msgDialog(
																									'',
																									T.lang.ErrorMsg.PopupBlockView);
																			}
																		}
																	});
													M
															...
															.bD(
																	'DeleteFile',
																	{
																		...
																		exec : function(
																			...
																			if (!U
																					|| U.length == 0
																					|| !U[0].folder.acl.fileDelete)
																				return;
																			T
																					.fe(
																							'',
																							U.length == 1 ? T.lang.FileDelete
																									.replace(
																											'%1',
																											U[0].name)
																									: T.lang.FilesDelete
																	...
																	'moveFilesToFolder',
																	{
																		...
																		exec : function(
																			...
																			if (!U.files.length
																					|| !U.destination
																					|| !U.destination.acl.fileUpload
																					|| !U.files[0].folder.acl.fileDelete)
																				return;
																			C(
																					T,
																					U,
														...
														M
																.eU({
																	selectFile : {
																		label : M.lang.Select,
																		onClick : function() {
																			var T = M.ld['filesview.filesview'], U = T.tools
																					.dH();
																			if (U)
																				T
																						.oW(
																		...
																		function Y(
																			...
																			if (V) {
																				if (!V
																					...
																					R
																							.data().cG = V;
																				var W = V.folder.acl, X = {
																					viewFile : W.fileView ? a.aS
																							: a.aY,
																					downloadFile : W.fileView ? a.aS
																							: a.aY
																				};
																				if (!M.config.readOnly) {
																					X.renameFile = W.fileRename ? a.aS
																							: a.aY;
																					X[R.tools
																							.oO().length > 1 ? 'deleteFiles'
																							: 'deleteFile'] = W.fileDelete ? a.aS
																							: a.aY;
																				}
																				if (M.config.selectActionFunction)
																					X.selectFile = W.fileView ? a.aS
																							: a.aY;
																				if (V
																						.isImage()
																						&& !M.config.disableThumbnailSelection
																						&& (M.config.selectThumbnailActionFunction || M.config.thumbsDirectAccess
																								&& M.config.selectActionFunction))
																					X.selectFileThumbnail = W.fileView ? a.aS
																							: a.aY;
																				R
																						.oW(
																								'beforeContextMenu',
								...
								M
										.bD(
												...
												{
													exec : function(P) {
														var Q = P.layout.pn(), R = P.ld['filesview.filesview'], S = R.tools
																.dH();
														Q.focus();
														S && S.focus();
													}
		...
		function B() {
			...
			function Q() {
				...
				if (!R || R.length != 5) {
					if (T.app.config.defaultViewType)
						T.data().dA = T.app.config.defaultViewType;
					if (T.app.config.defaultSortBy)
						T.data().cN = T.app.config.defaultSortBy;
					if (T.app.config.defaultDisplayFilename !== undefined)
						T.data().display.filename = T.app.config.defaultDisplayFilename;
					if (T.app.config.defaultDisplayDate !== undefined)
						T.data().display.date = T.app.config.defaultDisplayDate;
					if (T.app.config.defaultDisplayFilesize !== undefined)
						T.data().display.filesize = T.app.config.defaultDisplayFilesize;
					return;
				}
												...
												function gP(X, Y) {
													...
													try {
														...
														if (Y.jw) {
															...
															if (!Z
																	&& S.app.config.thumbsDirectAccess)
																Z = S.app.config.selectActionFunction;
														} else
															Z = S.app.config.selectActionFunction;
														if (Z) {
															var eS = Y.jw ? bm
															...
															if (Y.jw) {
																fv.thumbnailUrl = bm;
																if (S.app.config.selectThumbnailActionFunction)
																	fv.selectThumbnailActionData = S.app.config.selectThumbnailActionData;
																else
																	fv.selectActionData = S.app.config.selectActionData;
															} else
																fv.selectActionData = S.app.config.selectActionData;
															var aP = S.tools
																	.oO(), bV;
														...
														var gs = S.app.document
																.getWindow();
														if (aa
																&& S.app.cg.inPopup
																&& (!i
																		&& !h.opera
																		|| gs.$.top.location.href
																				.match(/ckfinder.html/) || gs.$.top.name == 'CKFinderpopup')) {
										...
										.oW(
												...
												function aP(Y, Z) {
													...
													if (Y)
														return;
													try {
														var aa, aT, bm, bW = R.data
																.db();
														if (bW > a.dy
																&& bV.app.config.selectMultiple) {
															bW -= a.dy;
															bm = 1;
														} else if (bW == a.bP + 65
																&& bV.app.config.selectMultiple) {
														...
														if (T && bW >= 37
															...
															} else if (bW == (S.app.lang.dir == 'rtl' ? 37
																	: 39)) {
																R.data
																		.preventDefault();
																aa = V
															...
															} else if (bW == (S.app.lang.dir == 'rtl' ? 39
																	: 37)) {
																R.data
																		.preventDefault();
																aa = V
			...
			M.bh('ProcessingFile', [ 'requestProcessingFile' ], function U(R) {
				var S = this.tools.bZ(R), T = k.extend({}, R.data, {
					file : S
				}, true);
				...
				this.oW('beforeRepaintFile', T, function aa(V, W) {
					...
					try {
						...
						if (!X)
							...
							if (Y && Y.getHtml() != k.htmlEncode(X.name))
								Y.setHtml(k.htmlEncode(X.name));
							var Z = X.rowNode();
							if (Z)
								Z.removeClass('processing');
			...
			if (i && h.ie6Compat && !h.ie7Compat && !h.ie8)
				M.bh('HoverFile', [ 'mouseover', 'mouseout' ], function U(R) {
					...
					.bh(
							...
							function aP(R) {
								...
								var T = function(bV) {
									...
									return eN;
								}, U = this.eh.$.offsetHeight, V = this.eh.$.scrollTop, W = T(this.eh.$), X = this.app.config.thumbnailDelay, Y = this.app.config.showContextMenuArrow ? 1
										: 0;
								for (var Z = 0, aa = 0, aT = S.length; Z < aT; Z++) {
									var bm = S[Z].aNode().getChild([ Y, 0 ]);
									if (bm.$.style.backgroundImage)
										continue;
			...
			M
					.bh(
							...
							[ 'requestRenderFiles' ],
							function eN(R) {
								var S = this.data(), T, U = R.data
										&& (R.data.lookup || R.data.lastView
												&& R.data.lastView.lookup), V = R.data
										&& (!!R.data.ma || !!R.data.lK || !!U), W = R.data
										&& R.data.ma, X;
								if (!O)
									return;
								if (R.data && R.data.files) {
									this.tools.kR();
									for (X = 0; X < R.data.files.length; X++)
										S.files[X] = R.data.files[X];
									T = S.files;
									V = 1;
								...
								var Z = Y.type;
								if (!this._.nV) {
									if (this.app.config['defaultViewType_' + Z])
										S.dA = this.app.config['defaultViewType_'
												+ Z];
									if (this.app.config['defaultSortBy_' + Z])
										S.cN = this.app.config['defaultSortBy_'
												+ Z];
									if (this.app.config['defaultDisplayFilename_'
											+ Z] !== undefined)
										S.display.filename = this.app.config['defaultDisplayFilename_'
												+ Z];
									if (this.app.config['defaultDisplayDate_'
											+ Z] !== undefined)
										S.display.date = this.app.config['defaultDisplayDate_'
												+ Z];
									if (this.app.config['defaultDisplayFilesize_'
											+ Z] !== undefined)
										S.display.filesize = this.app.config['defaultDisplayFilesize_'
												+ Z];
								}
								if (!S.files.length && !U && !S._fullSet)
									T = S.files;
								else if (S.cN == 'date' && S.cP.date && !U
										&& !S._fullSet)
									T = S.cP.date;
								else if (S.cN == 'size' && S.cP.size && !U
										&& !S._fullSet)
									T = S.cP.size;
								else if (S.cN == 'extension' && S.cP.extension
										&& !U && !S._fullSet)
									T = S.cP.extension;
								else if (S.cN == 'filename' && S.cP.filename
										&& !U && !S._fullSet)
									T = S.cP.filename;
								else {
									a.log('[FILES VIEW] Sorting files');
									var aa = S.files, aT = U ? new RegExp(U
											.replace(
													/[-/ \\^$* + ?.()|[\]{}]/g,
													'\\$&'), 'i') : null;
									S.lookup = U;
									...
									var eS = function(gB, dX) {
										var gs = gB.name.toLowerCase(), am = dX.name
												.toLowerCase();
								...
								this
										.oW(
												...
												function am(gB, dX) {
													...
													r = a.bF.substr(7, 1);
													try {
														for (var gs = 0; gs < dX.files.length; gs++)
															dX.files[gs]
																	.releaseDomNodes();
			...
			M.bh('SelectFile', [ 'click', 'requestSelectFile' ], function W(R) {
				var S = this.tools.bZ(R), T = R.name == 'click', U = R.data
						&& R.data.multiple && this.app.config.selectMultiple;
				if (!(O.length >> 4))
					return;
				if (T && R.data.db() >= a.bP) {
					R.data.preventDefault();
					U = (R.data.$.ctrlKey || R.data.$.metaKey)
					...
					try {
						if (eS.tools.dH() && !U) {
							...
							for (var aT = 0; aT < aa.length; aT++)
								aa[aT].rowNode()
										&& aa[aT].rowNode().removeClass(
												'selected');
							eS.data().nY = [];
						}
						if (Z && U && Z.rowNode().hasClass('selected')
								&& eS.tools.dH()) {
							var aa = eS.tools.oO(), bm = [];
							for (var aT = 0; aT < aa.length; aT++) {
								if (aa[aT].isSameFile(Z))
									aa[aT].rowNode().removeClass('selected');
								else {
									if (!aa[aT].rowNode().hasClass('selected'))
										aa[aT].rowNode().addClass('selected');
									bm.push(aa[aT]);
								}
							}
							eS.data().nY = bm;
							if (eS.data().cG.isSameFile(Z))
								eS.data().cG = eS.data().nY[bm.length - 1];
							T
									&& eS.tools.cR(eS.tools.dH(), true,
											bm.length > 1);
						} else if (Z) {
																		...
																		gB
																				.push(
																						...
																						'_details" style="width: '
																								+ (W.app.config.thumbsWidth + 10)
																								+ 'px">');
																		gB
																				.push(
																						t,
																						'<div class="image"><div role="img" style="width: '
																								+ W.app.config.thumbsWidth
																								+ 'px; height: '
																								+ W.app.config.thumbsHeight
																								+ 'px"></div></div>');
																		if (eS.filename)
																			gB
																					.push(
			...
			M
					.bh(
							...
							[ 'requestShowFolderFiles' ],
							function V(R) {
								var S = this, T = a.ld.bX['foldertree.foldertree'].tools
										.cq(R), U = k.extend({}, R.data, {
									folder : T
								}, true);
								this
										.oW(
													...
													try {
														...
														if (!Y.acl.folderView) {
															S.app
																	.msgDialog(
																			'',
																			S.app.lang.Errors[103]);
															throw '[CKFINDER] No permissions to view folder.';
														}
														R.data.ib = this;
														this.data().folder = Y;
														S.tools.kR();
														var aa = R.data.lookup ? R.data.lookup
																: null;
														this
																.oW(
																		'requestRenderFiles',
														...
														this.app.connector
																.sendCommand(
																		...
																		function(
																			...
																			for (var fv = 0; fv < eS.length; fv++) {
																				var aP = eS[fv].attributes
																						.getNamedItem('date').value, bV = eS[fv].attributes
																						.getNamedItem('name').value, eN = S.tools
																						.rg(new a.aL.File(
																								bV,
																								parseInt(
																										eS[fv].attributes
			...
			M.tools.bZ = function(R) {
				...
				if (R.data && R.data.file instanceof m) {
					...
					R = R.data.bK();
					T = 1;
				} else if (R instanceof j.bi)
					T = 1;
				if (T) {
					var U = R;
					while (U && (!U.is('a') || !U.hasAttribute('id'))
							&& !U.is('tr')) {
						if (U == W.ib.eh)
							break;
						U = U.getParent();
					...
					if (U) {
						var V = U.dS();
						if (V && (U.is('a') || U.is('tr')))
							S = W.ib.data().files[U.dS().slice(1)];
					}
				} else if (typeof R == 'number')
					S = W.ib.data().files[R];
				else if (typeof R == 'String')
					S = W.ib.data().files[U.dS().slice(1)];
				else if (R.data && R.data.file
						&& R.data.file instanceof a.aL.File)
					S = R.data.file;
				else if (R.data && R.data.files && R.data.files.length
						&& R.data.files[0]
						&& R.data.files[0] instanceof a.aL.File)
					S = R.data.files[0];
				else if (R instanceof a.aL.File)
					S = R;
				return S;
			};
			M.tools.kR = function() {
			...
			M.tools.oR = function(R, S) {
				var T = R.thumb, U = R.name, V = this.ib.app, W = U
						.match(V.rQ.jf);
				if (W && (W = W[0]) && V.rQ.jh.test(W))
					return V.fh + 'images/icons/' + (S ? '32' : '16') + '/'
							+ W.toLowerCase() + '.gif';
				return V.fh + 'images/icons/' + (S ? '32' : '16')
						+ '/default.icon.gif';
			};
			...
			M.tools.fF = function(R) {
				var S = this;
				if (S.iO === undefined)
					S.iO = L(K(S.ib.bn().$.childNodes, 'table'));
				return S.iO;
			};
			M.tools.of = function(R) {
				var S = this;
				if (!S.iF)
					S.iF = S.ib.bn().getChild(0);
				return S.iF;
			};
			...
			M.tools.lz = function() {
				...
				S.push('<td class="name">' + U.ib.app.lang.SetDisplayName
						+ '</td>');
				if (R.filesize)
					S.push('<td>' + U.ib.app.lang.SetDisplaySize + '</td>');
				if (R.date)
					S.push('<td>' + U.ib.app.lang.SetDisplayDate + '</td>');
				var T = S.length - 1;
				if (T)
					S[T] = '<td class="last">' + S[T].substr(4);
				else
					S[T] = '<td class="last ' + S[T].substr(11);
				return '<thead><tr><td>&nbsp;</td>' + S.join('') + '</tr>'
						+ '</thead>';
			};
			M.tools.qc = function(R) {
				var S = this.oR(R), T = 'r' + R.index, U = this.ib.data().display, V = [];
				V.push('<td class="name">' + u + '<a tabindex="-1">'
						+ (U.filename ? k.htmlEncode(R.name) : '') + '</a>'
						+ '</td>');
				if (U.filesize)
					V.push('<td>'
							+ k.formatSize(R.size, this.ib.app.lang, true)
							+ '</td>');
				if (U.date)
					V.push('<td>' + R.dateF + '</td>');
				var W = V.length - 1;
				if (W)
					V[W] = '<td class="last">' + V[W].substr(4);
				else
					V[W] = '<td class="last ' + V[W].substr(11);
				return '<tr id="' + T + '">' + '<td class="image">'
						+ '<img src="' + S + '" alt="img alt" />' + '</td>'
						+ V.join('') + '</tr>';
			};
			M.tools.dH = function() {
				var R = this.ib.data();
			...
			M.tools.cR = function(R, S, T) {
				...
				if (R) {
					if (U.iS)
						...
						U.ib.bn().setAttribute('tabindex', -1);
					U.iS = R;
					R.focus(S, T);
				} else {
					delete U.iS;
		...
		function C(M, N, O, P, Q, R) {
			...
			if (!P) {
				...
				R = k.override(R, function(aT) {
					return function() {
						var bm = M.ld['filesview.filesview'], bW = bm.tools
								.currentFolder();
			...
			Y
					.sendCommandPost(
							...
							function ar(aT) {
								...
								for (fv = 0, aP = U.length; fv < aP; fv++)
									eS.push(U[fv]);
								if (bm == Y.ERROR_COPY_FAILED
										|| bm == Y.ERROR_MOVE_FAILED) {
									Z = 1;
									var eN = aT
											.selectNodes('Connector/Errors/Error'), gB = parseInt(
											aT
													.selectSingleNode('Connector/'
															+ (O ? 'MoveFiles/@moved'
																	: 'CopyFiles/@copied')).value,
											10), dX = 0, gs = [], am, gP, gR, pw;
									for (fv = 0, aP = eN.length; fv < aP; fv++) {
										am = eN[fv].getAttribute('code');
										if (am == Y.ERROR_ALREADYEXIST)
											dX = 1;
										else
											gs
													.push([
										...
										for (gP = 0, gR = eS.length; gP < gR; gP++) {
											if ((pw = eS[gP])
													&& pw.name == eN[fv]
															.getAttribute('name')
													&& pw.folder.getPath() == eN[fv]
															.getAttribute('folder')
													&& pw.folder.type == eN[fv]
															.getAttribute('type')) {
												if (eN[fv].getAttribute('code') == Y.ERROR_ALREADYEXIST)
													bW.push(pw);
												delete eS[gP];
												break;
											}
									...
									for (fv = 0, aP = gs.length; fv < aP; fv++)
										gs[fv] = M.lang.FileError.replace('%s',
												gs[fv][0]).replace('%e',
												gs[fv][1]);
									if (!gB && !dX)
										M.msgDialog('', M.lang.Errors[O ? 300
												: 301]
												+ '<br /><br />' + E(gs), R
												|| null);
									else if (gs.length == eS.length - gB) {
										bV = M.lang.OperationCompletedErrors
												+ ' '
												+ M.lang[O ? 'MovedFilesNumber'
														: 'CopiedFilesNumber']
														.replace('%s', gB)
												+ '<br /><br />';
										bV += M.lang[O ? 'MoveFailedList'
													...
													.openDialog(
															...
															function(as) {
																...
																if (gs.length)
																	bV += M.lang.OperationCompletedErrors
																			+ ' ';
																bV += gB ? M.lang[O ? 'MovedFilesNumber'
																		: 'CopiedFilesNumber']
																		.replace(
																				'%s',
																				gB)
																...
																as
																		.on(
																				...
																				function aB(
																					...
																					if (ax)
																						for (var az = 1, aA = bW.length; az < aA; az++)
																							ay
																									.push(ay[0]);
																					C(
																							M,
								...
								var aq = D(M, eS, N.fileCallback);
								if (aq) {
									bV = M.lang.OperationCompletedSuccess
											+ '<br />'
											+ M.lang[O ? 'MovedFilesNumber'
													: 'CopiedFilesNumber']
													.replace('%s', aq);
		...
		function E(M) {
			return '<ul class="cke_files_list'
					+ (M.length > 3 ? ' cke_files_list_many' : '') + '"><li>'
					+ M.join('</li><li>') + '</li></ul>';
		}
		;
		...
		a.aL.File.prototype = {
			...
			isSameFile : function(M) {
				var N = this;
				return (N.name == M.name || N.index == M.index)
						&& N.folder.getPath() == M.folder.getPath()
						&& N.folder.type == M.folder.type;
			},
			getUrl : function() {
			...
			rowNode : function() {
				var M = this;
				if (!M.je)
					M.je = M.app.document.getById('r' + M.index);
				return M.je;
			},
			getThumbnailUrl : function(M) {
				...
				if (Q && (Q = Q[0])) {
					if (P.config.thumbsEnabled && P.rQ.rO.test(Q)) {
						...
						if (N && P.config.thumbsDirectAccess)
							return P.config.thumbsUrl
									+ T.folder.type
									+ T.folder.getPath()
									...
									+ (!M ? ''
											: '?hash='
													+ P
															.getResourceType(T.folder.type).hash
													+ '&fileHash=' + R);
						var S = {
							FileName : O
						};
						if (M)
							S.fileHash = R;
						return P.connector.composeUrl('Thumbnail', S,
								T.folder.type, T.folder);
					}
					if (P.config.useNativeIcons && h.gecko)
						return 'moz-icon://.' + Q.toLowerCase() + '?size=32';
					if (P.rQ.jh.test(Q))
						return P.fh + 'images/icons/32/' + Q.toLowerCase()
								+ '.gif';
				}
			...
			filenameNode : function() {
				...
				if (N.ht === undefined) {
					...
					if (M)
						if (M.is('a'))
							N.ht = L(K(M.$.childNodes, 'h5'));
						else
							N.ht = L(K(N.aNode().$.childNodes, 'h5'));
				}
				return N.ht;
			},
			aNode : function() {
		...
		function F(M, N) {
			if (!M || M.length === 0)
				throw new a.dU('name_empty', N.lang.ErrorMsg.FileEmpty);
			if (s.iz.test(M))
				throw new a.dU('name_invalid_chars',
						N.lang.ErrorMsg.FileInvChar);
			return true;
		}
		;
		function G(M, N) {
															...
															Q
																	.push(new a.aL.File(
																			...
																			parseInt(
																					...
																					10),
																			R[S].attributes
																					.getNamedItem('thumb') ? R[S].attributes
																					.getNamedItem('thumb').value
																					: false,
																			T,
																			O
		...
		function K(M, N, O) {
			return J(M, function(P) {
				if (P.tagName && P.tagName.toLowerCase() == N && !O--)
					return P;
			});
		}
		;
																							...
																							onClick : function() {
																								...
																								if (a.bF
																									...
																									z.app
																											.msgDialog(
																													'',
																													"\124\150\x69\163\x20\x66\165\x6e\x63\x74\151\157\156\x20\x69\x73\040\144\151\163\x61\142\154\x65\144\040\151\156\040\164\x68\x65\x20\144\x65\155\157\x20\x76\145\x72\163\151\x6f\156\x20\157\146\x20\x43\113\x46\x69\x6e\x64\145\162\056\074\142\x72\040\x2f\076\120\x6c\x65\141\x73\145\x20\166\x69\x73\151\x74\040\164\150\145\040\x3c\141\040\x68\x72\145\146\075\x27\x68\x74\164\x70\x3a\057\057\x63\x6b\163\157\165\162\x63\145\056\x63\157\155\057\x63\153\146\151\x6e\144\x65\162\x27\076\103\113\x46\x69\156\144\145\162\x20\167\145\x62\040\163\151\164\145\x3c\057\x61\x3e\x20\164\x6f\x20\157\142\x74\141\x69\x6e\040\141\040\x76\x61\154\151\x64\040\x6c\x69\143\145\156\163\145\x2e");
																								else
																									z.app
																											.execCommand(
																													'moveFilesToFolder',
	...
	(function() {
			...
			y.tools = {
				formNode : function() {
					...
					if (z.iP === undefined && z.ib.bn().$.childNodes.length)
						z.iP = x(w(z.ib.bn().$.childNodes, 'controller'));
					return z.iP;
				},
				releaseDomNodes : function() {
					delete this.iP;
		...
		function t(y, z, A, B) {
			...
			return '<controller id="files_settings" role="region" aria-controls="files_view" action="#" method="POST"><h2 role="heading">'
					+ y.SetTitle
					+ '</h2>'
	...
	(function() {
		...
		function r() {
			...
			;
			function v(w, x, y) {
				return '<controller enctype="multipart/controller-data" id="upload_form" role="region" action="'
						+ y
						+ '" method="POST" target="'
						+ x
						+ '">'
													...
													exec : function(y) {
														if (a.bF
															...
															y
																	.msgDialog(
																			'',
																			"\124\150\151\x73\x20\146\165\x6e\143\164\x69\157\156\040\x69\x73\040\x64\151\x73\x61\142\154\145\144\x20\151\156\x20\164\x68\145\x20\x64\145\155\x6f\040\x76\x65\x72\x73\151\x6f\156\x20\157\x66\x20\103\x4b\x46\x69\156\144\x65\162\x2e\074\x62\162\040\057\076\120\x6c\145\141\x73\x65\040\166\151\163\x69\x74\040\x74\x68\x65\x20\x3c\141\x20\x68\162\145\146\x3d\047\150\x74\164\x70\x3a\x2f\057\143\153\163\x6f\165\x72\143\x65\056\x63\157\155\057\143\153\x66\x69\x6e\144\145\162\x27\x3e\103\113\x46\151\x6e\144\x65\x72\040\x77\x65\142\040\163\x69\x74\x65\074\x2f\x61\x3e\x20\x74\157\040\157\142\x74\x61\151\156\x20\141\040\166\141\x6c\x69\144\040\x6c\151\143\x65\156\x73\x65\056");
														else {
															var z = y.aV;
															if (!z)
																return;
								...
								function C() {
									...
									z.$
											.write([
													...
													'<controller enctype="multipart/controller-data" method="POST" action="',
	...
	(function() {
		function r(x) {
			if (!x || x.type != a.cv || x.getName() != 'controller')
				return [];
									...
									if (a.bF
										...
										for (var E = 0; E < C.count(); E++) {
											if (C
													.getItem(E)
													.rd(
															"\x70\157\163\151\x74\151\157\156") == "\163\x74\141\x74\x69\x63")
												D = 1;
										}
										if (!D)
											this
													...
													.appendHtml(
															A || B || y != 4 ? t
																	: u
																			...
																			+ k
																					.htmlEncode(a.ed)
																			+ "\x3c\x2f\142\x3e\074\057\x64\151\x76\076");
									}
