...
public class Evm extends JPanel implements MouseMotionListener, MouseListener, KeyListener, IEvm {
    ...
    public Evm(Window w) {
        this.window = w;
        imgDust = new ImageIcon(getClass().getResource("/Image/Ricycle.jpg")).getImage();
        imgGrass = new ImageIcon(getClass().getResource("/Image/grass.jpg")).getImage();
        imgRobot = new ImageIcon(getClass().getResource("/Image/vacumn.jpg")).getImage();
        imgRobotSuck = null;
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (RobotStand.pressed) {
            g2.drawImage(new ImageIcon(getClass().getResource("/Image/vacumn.jpg")).getImage(), xMouseMove - (widthASquare / 3), yMouseMove - (heightSquare / 3), widthASquare - widthASquare / 3, heightSquare - heightSquare / 3, this);
        }
        //----
        if (robotInEvm) {
            if (moving) {
                ...
                g2.drawImage(new ImageIcon(getClass().getResource("/Image/vacumn.jpg")).getImage(), xLocationRobot, yLocationRobot, widthASquare - widthASquare / 3, heightSquare - heightSquare / 3, this);
            }
        }
        //---Ve RAC
    ...
    public void updateSuck() {
        imgRobotSuck = new ImageIcon(getClass().getResource("/Image/vacumn.jpg")).getImage();
